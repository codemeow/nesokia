...
struct nsk_options_program nsk_options_program = {
    .profile = {
        ...
        .decoder = {
            .maxsegmentframes = 180,
            .minnoteframes = 3,
            .boundarypenalty = 0.50,
            .shortnotepenalty = 1.35,
            .snappenalty = 0.18,
            .nonmarkboundarypenalty = 1.50,
            .boundarynearradius = 2,
            .edgecostweight = 0.35,
            .markp2pdeltathreshold = 0.05,
            .markp2pactivethreshold = 0.08,
            .restnotemismatchcost = 1.40,
            .maxmididistancecost = 2.40,
            .mididistanceweight = 0.42,
            .periodminscore = 0.72,
            .periodresidualweight = 0.90,
            .periodmididistanceweight = 0.32,
            .enabletransitionsmear = true,
            .smearmaxshortframes = 4,
            .smeartargetframes = 6,
            .smearminlongframes = 24,
            .enablesixframesnap = true,
            .enableresidualsnap = true,
            .enableoctaveboundarysnap = true,
            .octaveboundaryperiodminscore = 0.88,
            .adaptivedenseenabled = true,
            .adaptivedenseboundaryratio = 0.65,
            .localdenseminstrictcount = 12,
            .localdensemaxgap = 2,
            .localdensemindensity = 0.45,
            .localdensepreviousextension = 4,
            .localdensenextextension = 6,
            .localdensemergegap = 6,
            .unknownnotepenalty = 0.25,
            .fragmentationweight = 0.01,
            .densearbitrationmargin = 0.002
        },
        .select = {
